    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="{{route('users.update',$user->id)}}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
          {{-- enctype="multipart/form-data"让form认识文件 --}}
          ...
          <div class="form-group">
            ...
            <textarea name="introduction" id="introduction-field" class="form-control" rows="3" placeholder="{{$user->introduction}}"></textarea>
          </div>
